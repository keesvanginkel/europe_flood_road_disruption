...
if __name__ == '__main__':
    cntrySetup = pd.read_csv(r"D:\COACCH_paper\europe_flood_road_disruption\data\nuts3_combinations.csv")
    countries_ = ['CZE', 'DNK', 'GRC', 'ESP', 'HUN', 'IRL', 'POL', 'SRB', 'SVK', 'AUT']  # 'BEL', 'DEU', 'NLD',
    reps_ = 500
    outputFolder = r"D:\COACCH_paper\data\output\{}"
